...
/***************************************************************************//**
 * @brief
 *   Init PSA module for generated random number.
 ******************************************************************************/
 ...
 *
 * @param[in] val_1
 *   First range unsigned value.
 *
 * @param[in] val_2
 *   Second range unsigned value.
 *
 * @return
 *   Generated random unsigned number between smallest value and biggest value between val_1 and val_2.
 ******************************************************************************/
