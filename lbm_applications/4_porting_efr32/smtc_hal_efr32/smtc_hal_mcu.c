...
extern void smtc_modem_hal_set_ant_switch_wmbus(bool is_enable);
#endif
// -----------------------------------------------------------------------------
//                              Macros and Typedefs
// -----------------------------------------------------------------------------
...
static void hal_mcu_gpio_init(void)
{
  ...
  hal_gpio_irq_t dio_pin_irq = {
    .port = RADIO_DIO1_PORT,
    .pin = RADIO_DIO1_PIN,
    .pull_mode = RADIO_DIO1_PULL_MODE,
    .irq_mode = RADIO_DIO1_IRQ_MODE,
    .callback = NULL,
    .context = NULL
  };
...
#elif  defined(RADIO_ANTENNA_SWITCH_PORT)
  hal_gpio_init_out(RADIO_ANTENNA_SWITCH_PORT, RADIO_ANTENNA_SWITCH_PIN, 1);
#endif

#if LBM_SP3T_RF_SWITCH_MANUAL
  hal_gpio_init_out(RADIO_SP3T_RF_SWITCH_VC2_PORT, RADIO_SP3T_RF_SWITCH_VC2_PIN, 0);
  hal_gpio_init_out(RADIO_SP3T_RF_SWITCH_VC3_PORT, RADIO_SP3T_RF_SWITCH_VC3_PIN, 0);
  smtc_modem_hal_set_ant_switch_wmbus(false);
#endif // LBM_SP3T_RF_SWITCH_MANUAL
  hal_gpio_irq_enable();
}
