 ...
 ******************************************************************************/
 ...
 // NOTE: SL_BOARD_ENABLE_VCOM, SL_BOARD_ENABLE_DISPLAY, and
 // SL_BOARD_ENABLE_SENSOR_RHT are configured by hardware,
 // not by firmware. Changing these defines in this file has no effect.
