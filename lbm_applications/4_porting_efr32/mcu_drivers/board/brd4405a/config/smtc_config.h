...
// SP3T RF Switch
#ifndef LBM_SP3T_RF_SWITCH_MANUAL
#define LBM_SP3T_RF_SWITCH_MANUAL   1
#endif
...
#define RADIO_DIO1_PORT         SMTC_RADIO_CTL_DIO1_PORT
#define RADIO_DIO1_PIN          SMTC_RADIO_CTL_DIO1_PIN
#define RADIO_SP3T_RF_SWITCH_VC2_PORT    SMTC_RADIO_CTL_ANTSW_VC2_PORT
#define RADIO_SP3T_RF_SWITCH_VC2_PIN     SMTC_RADIO_CTL_ANTSW_VC2_PIN
#define RADIO_SP3T_RF_SWITCH_VC3_PORT    SMTC_RADIO_CTL_ANTSW_VC3_PORT
#define RADIO_SP3T_RF_SWITCH_VC3_PIN     SMTC_RADIO_CTL_ANTSW_VC3_PIN

// Radio DIOX IRQ config
#define RADIO_DIO1_IRQ_MODE     SL_GPIO_INTERRUPT_RISING_EDGE
#define RADIO_DIO1_PULL_MODE    SMTC_HAL_GPIO_PULL_MODE_UP
#endif
