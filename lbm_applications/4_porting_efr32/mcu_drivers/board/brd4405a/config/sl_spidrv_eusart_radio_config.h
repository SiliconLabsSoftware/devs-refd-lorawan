...
#define SMTC_RADIO_CTL_BUSY_PIN            6

// GPIO RST on PC0
#define SMTC_RADIO_CTL_RESET_PORT          SL_GPIO_PORT_C
#define SMTC_RADIO_CTL_RESET_PIN           0

#define SMTC_RADIO_CTL_DIO1_PORT           SL_GPIO_PORT_D
#define SMTC_RADIO_CTL_DIO1_PIN            2

// SP3T RF Switch on VC2 on PC8
#define SMTC_RADIO_CTL_ANTSW_VC2_PORT      SL_GPIO_PORT_C
#define SMTC_RADIO_CTL_ANTSW_VC2_PIN       8

// SP3T RF Switch on VC3 on PC9
#define SMTC_RADIO_CTL_ANTSW_VC3_PORT      SL_GPIO_PORT_C
#define SMTC_RADIO_CTL_ANTSW_VC3_PIN       9
