/***************************************************************************//**
 * @file
 * @brief SPIDRV_EUSART Config — BRD4187C (EFR32MG24) + external SX126x
 *******************************************************************************
 * BRD4187C (EFR32MG24): radio SPI on EUSART1 at EXP pins per MG24 header map:
 *   MOSI PC1 (EXP4), MISO PC2 (EXP6), SCK PC3 (EXP8), NSS PC0 (EXP10).
 * Control / RF switch GPIOs aligned to the same EXP positions as BRD4400C cable map:
 *   DIOx PA8 (EXP12), RST PA9 (EXP14), BUSY PA7 (EXP13), ANT_SW PA6 (EXP11).
 * Note: PA8/PA9 are also US0/VCOM lines on MG24 — disable VCOM or avoid using it
 * in parallel if those EXP pins are wired to the radio.
 *
 * Verify against your Sub-GHz adapter / wiring; adjust if your hardware differs.
 *******************************************************************************
 * # License
...
#define SL_SPIDRV_EUSART_RADIO_TX_PORT           SL_GPIO_PORT_C
#endif
#ifndef SL_SPIDRV_EUSART_RADIO_TX_PIN           
#define SL_SPIDRV_EUSART_RADIO_TX_PIN            1
#endif

// EUSART1 RX on PC02
#ifndef SL_SPIDRV_EUSART_RADIO_RX_PORT          
#define SL_SPIDRV_EUSART_RADIO_RX_PORT           SL_GPIO_PORT_C
#endif
#ifndef SL_SPIDRV_EUSART_RADIO_RX_PIN           
#define SL_SPIDRV_EUSART_RADIO_RX_PIN            2
#endif

// EUSART1 SCLK on PC03
#ifndef SL_SPIDRV_EUSART_RADIO_SCLK_PORT        
#define SL_SPIDRV_EUSART_RADIO_SCLK_PORT         SL_GPIO_PORT_C
#endif
...
#define SL_SPIDRV_EUSART_RADIO_CS_PIN            0
#endif
// [EUSART_SL_SPIDRV_EUSART_RADIO]$
...
// BUSY on PA7 (EXP_HEADER13, MG24)
#define SMTC_RADIO_CTL_BUSY_PORT           SL_GPIO_PORT_A
#define SMTC_RADIO_CTL_BUSY_PIN            7

// RST on PA9 (EXP_HEADER14, MG24)
#define SMTC_RADIO_CTL_RESET_PORT          SL_GPIO_PORT_A
#define SMTC_RADIO_CTL_RESET_PIN           9

// DIOx (IRQ) on PA8 (EXP_HEADER12, MG24)
#define SMTC_RADIO_CTL_DIO1_PORT           SL_GPIO_PORT_A
#define SMTC_RADIO_CTL_DIO1_PIN            8

// RF switch on PA6 (EXP_HEADER11, MG24)
#define SMTC_RADIO_CTL_ANTSW_PORT          SL_GPIO_PORT_A
#define SMTC_RADIO_CTL_ANTSW_PIN           6
// [GPIO_SMTC_RADIO_CTL]$
